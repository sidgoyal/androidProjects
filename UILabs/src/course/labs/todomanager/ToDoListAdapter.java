...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			itemLayout = (RelativeLayout) inflator.inflate(R.layout.todo_item,
					null);
			...
			TextView titleView = (TextView) itemLayout
			 ...
			 * 
			 * 
			 * case DONE: statusView.setChecked(true); break; case NOTDONE:
			 * statusView.setChecked(false); break; default: Log.i("SHIT",
			 * "default in switch getstatus()"); return null; } //
			...
			statusView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
						...
						public void onCheckedChanged(CompoundButton buttonView,
							...
							// TODO - Set up and implement an
							// OnCheckedChangeListener, which
							// is called when the user toggles the status
							// checkbox
							if (isChecked){
