	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		resetButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.i("bebefore","before invalidate ");
				/*
				mTitleText.setText("");
				mDefaultStatusButton = (RadioButton) findViewById(R.id.statusNotDone);
				mDefaultPriorityButton = (RadioButton) findViewById(R.id.medPriority);
				mPriorityRadioGroup.seti
				mStatusRadioGroup = (RadioGroup) findViewById(R.id.statusGroup);
				dateView = (TextView) findViewById(R.id.date);
				timeView = (TextView) findViewById(R.id.time);
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				int priorityId = mPriorityRadioGroup.getCheckedRadioButtonId();
				switch (priorityId){
				...
				default:
					Log.i("SHIT","default on switch submit button priority");
					break;
				}
				...
				*/
				...
				status = getStatus();
				/*
				int statusId = mStatusRadioGroup.getCheckedRadioButtonId();
				switch (statusId){
				...
				case R.id.statusNotDone:
					...
					break;
				default:
					Log.i("SHIT","Default on status in add");
				}
				*/
